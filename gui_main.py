...
# Execute Button
ttk.Button(mainframe, text="Find and Move!", command= lambda: compare_and_move(root,"gui",folder_duplicate,folder_original,folder_separated,ignore_map)).grid(column=3, row=5, sticky=(W, E), padx="20", pady="30")
